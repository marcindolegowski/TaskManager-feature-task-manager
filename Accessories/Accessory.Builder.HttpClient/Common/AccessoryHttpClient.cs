...
namespace Accessory.Builder.HttpClient.Common;

public class AccessoryHttpClient : IHttpClient
{
    private readonly System.Net.Http.HttpClient _client;
    private readonly HttpClientProperties _options;
    private readonly ILogger<AccessoryHttpClient> _logger;
    ...
    public AccessoryHttpClient(System.Net.Http.HttpClient client, HttpClientProperties options,
        ILogger<AccessoryHttpClient> logger)
    {
        _client = client;
        _options = options;
        _logger = logger;
